...
| `outroTransferSupport` | Seven canonical Character Outro contracts: five integrated through #190 and two reviewed single-activation bindings on the new backend lane. Explicit handoff, recipient history and the declared stack policy are required. |
