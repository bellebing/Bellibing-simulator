...
PR #198 is **MERGED and post-merge verified** at main merge commit `dde1023f0841eb4ea4b553bbc9a76a76ff7a6b2b`, with reviewed head `1d1fe8c8f1d095624a79a0ca3673428a545ed759`. Post-merge [Verify](https://github.com/bellebing/Bellibing-simulator/actions/runs/35495502015), [Export](https://github.com/bellebing/Bellibing-simulator/actions/runs/35495502038) and [Deploy](https://github.com/bellebing/Bellibing-simulator/actions/runs/35495502014) all succeeded, including the Deploy live-site verification job. The integration leaves readiness at **43/3/9/2**, all **83 pending edges / 72 dependency IDs** and six Reference Team blockers open, and only Augusta/Ciaccona DPS_READY.

Historical PR195 checkpoint: PR #195 is **MERGED and post-merge verified** at `f2f8db676ba9433d065e7b18d854e0245e77d9dd`. Parents are previous main `2b1ba64a239338a91919c96afe1f8f4ed9516a73` and reviewed `3348771486a32dc048e48dc5b6a9fedb19ccf90e`; tree `52e7fdc8bb5c255d5caf9f3687562f6eede78612` exactly matches the reviewed candidate. Post-merge [Verify1144](https://github.com/bellebing/Bellibing-simulator/actions/runs/34714534066), [Export1043](https://github.com/bellebing/Bellibing-simulator/actions/runs/34714534057) and [Deploy151](https://github.com/bellebing/Bellibing-simulator/actions/runs/34714534042) passed with 851/851 tests, full audits/strict build/whitespace/Chrome and five-surface local/Export/live parity. All 83 edges/72 IDs, readiness 43/3/9/2 and six Reference Team blockers remain unchanged.

Before integration, draft [PR #197](https://github.com/bellebing/Bellibing-simulator/pull/197) on `codex/product-calculation-coverage-2026-09-13` added exact same-hit Echo-card comparison for the existing 54 Character hit paths (492 facts), with independently qualified context for each build. That capability is now integrated through merged PR #197, and PR #198 subsequently integrated source-qualified combat-context assembly around it. Neither integration creates a new DPS-ready profile or closes a profile dependency. See the [product audit and consumer contract](BACKEND_PRODUCT_CAPABILITY_AUDIT_20260913.md). UI PR196/BUG-030 and original Flamewing WIP remain separate and preserved.
...
## Historical PR195 resource-state boundary
...
Integration status: PR #190/#191/#193 are merged and post-merge verified through `b03d43b3f1810b502099efb321be225ccfbba46c`; Verify1127 / Export1026 / Deploy149 passed with 832 tests. Earlier draft/authorization wording is historical. The [PR194 execution-closure follow-up](PROFILE_EXECUTION_CLOSURE_REVIEW_20260912.md) and PR195 are now merged; the post-PR195 checkpoint above is historical, while the current integrated state is post-PR198.
...
Implementation state: the primitive additions below are **integrated on main through PR #189**, with post-merge Verify #1085, Export #984 and Deploy #146 green. [Integration evidence](CHARACTER_BACKEND_INTEGRATION_REVIEW.md) records the source heads and preservation checks. All 83 exact pending edges and all six Reference Team blockers remain; changing an edge to `PRIMITIVE_AVAILABLE_REQUIRES_TIMELINE` does not resolve it. The subsequent #190 and #191 payloads are also merged. The #197 Echo comparison and subsequent #198 combat-context payload are now integrated; neither closes a profile dependency.
...
At the PR194 checkpoint, `src/profileExecutionWorkQueue.ts` partitioned the 83 exact edges as:
