...
| Voidwing Moth `echo-60001985` | [Version 3.6.13 Echo text](https://wuwa.wiki/en/codex/echoes/60001985) separates press from hold; the hold description is a maximum of 12 damage instances. | PARK active attack: scaling stat is missing and maximum hold hits do not establish actual landed count or a fixed complete hold action. Swap-cancel in Denia's profile does not prove a damage variant. A separately stated use-to-Outro ATK transfer is a possible independent canonical-effect review, not permission to execute damage. |
