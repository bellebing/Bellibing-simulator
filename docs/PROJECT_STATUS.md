...
The authorized next backend pass starts from that verified main on `codex/source-valid-execution-2026-09-11`. It first reviews missing Sonata S03/S10 lifecycle semantics and then re-ranks source-valid reuse against profile closure. Only #191 was authorized to merge; the next PR must remain draft and unmerged. Flamewing WIP remains preserved in the original checkout and outside this branch.
