...
Shorekeeper's Empirical Data partial-hit/multi-target allocation and Cartethyia's component Conviction amounts remain parked; no new evidence in this review resolves them. S03/S10 are not retried. All known bug/source/Reference Team boundaries remain pending.
