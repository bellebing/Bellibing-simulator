...
2. **Qiuyuan isolated Outro transfer:** existing canonical incoming Echo amplification fact, five presets across Cantarella, Galbrena, Phrolova, Qiuyuan and Sigrika. Must keep Character-owned ECHO damage separate from an equipped Echo cast; review before binding.
