...
function assertBuild(state, width, height) {
  ...
  if (state.wheelOverflowX !== 'hidden') throw new Error('Build carousel must clip to the finite AppShell.');
