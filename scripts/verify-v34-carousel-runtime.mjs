...
async function verifyWeaponOverlay(send, width, height, capturePath) {
  ...
  if(String(opened.equipStyle.background).includes('none')||opened.equipStyle.bgColor==='rgb(238, 238, 238)'||opened.equipStyle.color==='rgb(8, 9, 11)') throw new Error(`Equip Weapon must use dark in-system primary styling: ${JSON.stringify(opened.equipStyle)}`);
