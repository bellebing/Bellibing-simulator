...
async function verifyWeaponOverlay(send, width, height, capturePath) {
  ...
  if(!opened.visual.scrimBackground.includes('0.58')||!opened.visual.panelBackground.includes('0.88')||!opened.visual.panelBackground.includes('0.86')||!opened.visual.panelBackdrop.includes('blur(5px)')) throw new Error(`Weapon overlay transparency contract failed: ${JSON.stringify(opened.visual)}`);
