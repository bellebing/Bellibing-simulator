...
try{
  ...
  try{
    ...
    console.log(`- Weapon Preview/Equip separation passed with restored Build equipment summary plus frameless full-weapon hero Preview; grid cards stay browse-only and no preview card box or card flight exists; desktop equipped: ${desktopWeapon.equipped}, mobile smoke equipped: ${mobileWeapon.equipped}.`);
