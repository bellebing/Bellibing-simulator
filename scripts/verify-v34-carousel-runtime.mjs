...
try{
  ...
  try{
    ...
    console.log(`- Weapon Preview/Equip separation passed: preview browsing preserves Active/grid, Equip alone promotes to slot 1, tunnel Preview stays independent, and no card flights exist; desktop equipped: ${desktopWeapon.equipped}, mobile smoke equipped: ${mobileWeapon.equipped}.`);
