...
export const SONATA_CAST_WINDOW_SEMANTIC_SPLIT = {
  ...
  notes: [
    ...
    'The exact Jinhsi Standard Opener Celestial dependency is closed separately by jinhsi-standard-opener-combat-start-prebuff-v1 because current source explicitly starts combat with the no-Intro opener; the generic Sonata primitive itself closes no profile dependency.',
