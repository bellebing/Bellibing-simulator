...
export const ECHO_SKILL_SOURCE_REVIEW_V36 = {
  ...
  notes: [
    ...
    'Corrosaurus is now an exact safe attack-profile case: the pinned Rank-5 row proves one 273.60% ATK Fusion active hit, a 20-second cooldown, and the rendered main-slot text independently proves its missing +20% Echo Skill DMG Bonus. Profile timing remains separate.',
