...
export const ECHO_SKILL_SOURCE_REVIEW_V36 = {
  ...
  notes: [
    ...
    'Dreamless is now an exact safe attack-profile case: current Rank-5 source resolves five 54.08% ATK Havoc hits plus one 270.40% ATK Havoc hit. Its Rover (Havoc) +50% post-Liberation branch remains execution/window state rather than a permanent attack multiplier.',
