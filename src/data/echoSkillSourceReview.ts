...
export const ECHO_SKILL_SOURCE_REVIEW_V36 = {
  ...
  notes: [
    ...
    'Mech Abomination is now an exact safe attack/effect case from the pinned source: Rank-5 front strike is 48.64% ATK Electro, Mech Waste is 320% + 160% ATK Electro and explicitly counts as Resonator Outro Skill DMG, the cast grants 12% ATK for 15s, and cooldown is 20s. The source does not prove exact summon/hit/explosion timing, so profile timeline execution remains separate.',
