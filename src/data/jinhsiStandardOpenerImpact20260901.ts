...
export const JINHSI_STANDARD_OPENER_IMPACT_REVIEWS_20260901: readonly ProfileBackwardImpactReview[] = [
  {
    ...
    notes: [
      ...
      'Current rotation-concept source explicitly places the low-power opener before the rest of the team applies buffs. The aggregate opener-specific Jinhsi+Zhezhi+Verina incoming-state edge is therefore source-closed as inactive; later-cycle teammate execution and energy accounting require a future distinct canonical loop/team profile.',
      'The source target 100–125% Energy Regen remains guidance and is not promoted to an exact hard gate for this opener; future team-cycle accounting must be sourced separately.',
      'After applying source-specific closures, aggregate Jinhsi pending execution is reduced to AH-SKILL, Jué, Incandescence and the profile-specific engine-model edge.',
