...
export const PROFILE_BACKWARD_IMPACT_REVIEWS_V36: readonly ProfileBackwardImpactReview[] = [
  ...
  {
    reviewId: 'PROFILE-IMPACT-AALTO-HYBRID-2026-08-29-01',
    characterId: 'aalto',
    presetId: 'aalto-hybrid-jiyan',
    weaponRecommendationProfileId: 'aalto-hybrid-jiyan-weapons',
    checkedAt: '2026-08-29',
    patch: '3.6',
    reviewedWeaponEffectIds: ['STM-ER', 'STM-NEXT-ATK'],
    reviewedSonataSetIds: ['sonata-8'],
    reviewedEchoIds: ['echo-60000525'],
    pendingExecutionIds: [
      'weapon:static-mist:STM-NEXT-ATK:outro-next-resonator-adapter',
      'echo:echo-60000525:impermanence-heron-active-transfer-adapter',
      'rotation:aalto-hybrid-jiyan-shorekeeper:engine-model',
    ],
    result: 'REVIEWED_WITH_PENDING_EXECUTION',
    notes: [
      'Static Mist permanent Energy Regen is executable source truth; its Outro-triggered NEXT_RESONATOR ATK transfer requires the eventual rotation to prove Jiyan is the actual incoming Resonator.',
      'Moonlit Clouds is source-reviewed for the selected Hybrid path. Its incoming-resonator ATK transfer is conditional and must be proven by executable Outro state rather than treated as permanent uptime.',
      'Impermanence Heron is explicitly cast immediately before Aalto Outro in the selected source rotation; its active damage/resource/transfer lifecycle remains behind the existing active-transfer adapter boundary.',
      'Aalto Hybrid is SOURCE_SEQUENCE_ONLY. The separate source-backed Main DPS mode remains unpromoted because no reviewed fixed Aalto DPS action sequence has been established for canonical transcription.',
    ],
  },
  {
