...
export const PROFILE_READINESS_BASELINE = {
  ...
  expectedProfileCompletePendingFreezeCount: 3,
  expectedCharacterMechanicsSourceBlockedCount: 3,
  expectedProfileSourcePendingCount: 51,
  expectedDpsReadyCount: 0,
  notes: [
    'Current composable profile catalogs contain verified default packages for Augusta, Cartethyia and Ciaccona.',
    'Cartethyia and Ciaccona rotations are source-reviewed guide sequences only (SOURCE_SEQUENCE_ONLY), so neither can receive a DPS_READY freeze approval until executable rotation/combat coverage exists.',
    'Cartethyia Fleurdelys conditional extra Aero bonus remains behind its existing specialized Echo adapter boundary for later freeze/execution work.',
