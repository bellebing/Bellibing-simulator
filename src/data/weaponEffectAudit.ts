...
export const WEAPON_EFFECT_ROSTER_AUDIT_V36 = {
  ...
  notes: [
    '97 audited effect rows now cover 47 released weapons after Rectifier audit batch 2.',
    '74 released weapons remain explicitly PENDING_SOURCE_AUDIT; this is not zero-effect data.',
    'All 22 currently RELEASED Pistol weapons remain audited; Rectifier batch 2 adds five source-audited 4-star weapons and leaves 11 released Rectifiers pending.',
