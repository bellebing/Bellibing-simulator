...
export const WEAPON_EFFECT_ROSTER_AUDIT_V36 = {
  ...
  notes: [
    '90 audited effect rows now cover 42 released weapons after Rectifier audit batch 1.',
    '79 released weapons remain explicitly PENDING_SOURCE_AUDIT; this is not zero-effect data.',
    'All 22 currently RELEASED Pistol weapons remain audited; this batch adds five source-audited 5-star Rectifiers without claiming full Rectifier coverage.',
    'Firstlight\'s Herald team-ATK magnitude is raw-verified while its conflicting Kingfisher vs Snow Taint/Ripples trigger-state wording remains explicitly pending-model.',
