...
export const WEAPON_EFFECT_ROSTER_AUDIT_V36 = {
  ...
  notes: [
    '51 audited effect rows now cover 28 released weapons after Pistol audit batch 2.',
    '93 released weapons remain explicitly PENDING_SOURCE_AUDIT; this is not zero-effect data.',
