...
export const WEAPON_EFFECT_ROSTER_AUDIT_V36 = {
  ...
  notes: [
    '236 source-audited effect rows now cover all 121 currently RELEASED weapons; PENDING_SOURCE_AUDIT is zero.',
...
export const WEAPON_EFFECT_BACKWARD_IMPACT_REVIEWS_V36 = [
  ...
  },
  {
    ...
    weaponType: 'Sword',
    reviewedReleasedCharacterIds: [
      'aemeath', 'brant', 'camellya', 'cartethyia', 'changli', 'danjin', 'hiyuki', 'qingxiao', 'qiuyuan',
      'rover-aero', 'rover-electro', 'rover-havoc', 'rover-spectro', 'sanhua', 'yangyang', 'yangyang-xuanling',
    ],
    existingWeaponRecommendationProfileIds: [],
    result: 'REVIEWED_NO_EXISTING_PROFILE_CHANGE',
    notes: [
      'This review closes source-audited Weapon Effect coverage for all 27 currently RELEASED Swords and screens all 16 currently RELEASED Sword users.',
      'No production Sword Weapon Recommendation profile exists, so closing raw effect coverage does not create or mutate ranking/profile data.',
