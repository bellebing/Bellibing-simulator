...
export const WEAPON_EFFECT_CATALOG: readonly WeaponEffectData[] = [
  ...
  e({ effectId: 'RJ-ENERGY', weaponId: 'relativistic-jet', statOrEffect: 'Resonance Energy', rankValues: [6, 7, 8, 9, 10], valueUnit: 'FLAT_AMOUNT', effectType: 'INSTANT', trigger: 'Cast Resonance Skill', durationSeconds: null, triggerCooldownSeconds: 20, maxStacks: 1, appliesTo: 'SELF', simulatorMode: 'MANUAL', mechanicsStatus: 'VERIFIED_CONDITIONAL', sourceEffectText: 'Skill cast immediately grants Resonance Energy; the passive trigger can occur once every 20 seconds.', notes: 'Instant resource gain is modeled separately from the paired 16s ATK buff. No automatic skill-cast timing is assumed.', sourceLabels: ['Prydwen', 'Game8', 'Wuthering Waves Wiki'], sourceUrls: ['https://www.prydwen.gg/wuthering-waves/weapons?search=Relativistic+Jet', 'https://game8.co/games/Wuthering-Waves/archives/474513', 'https://wutheringwaves.fandom.com/wiki/Relativistic_Jet'], checkedAt: '2026-08-25', provenanceNotes: ['R1-R5 Energy values, skill-cast trigger and 20s trigger cooldown agree across the current cross-check sources.'] }),
  e({ effectId: 'RJ-ATK', weaponId: 'relativistic-jet', statOrEffect: 'ATK%', rankValues: [.10, .125, .15, .175, .20], effectType: 'TRIGGERED', trigger: 'Cast Resonance Skill', durationSeconds: 16, triggerCooldownSeconds: 20, maxStacks: 1, appliesTo: 'SELF', simulatorMode: 'MANUAL', mechanicsStatus: 'VERIFIED_CONDITIONAL', sourceEffectText: 'Skill cast grants a timed ATK increase for 16 seconds; the passive trigger has a 20-second cooldown.', notes: 'The rotation must decide whether the 16s ATK window overlaps a modeled action.', sourceLabels: ['Prydwen', 'Game8', 'Wuthering Waves Wiki'], sourceUrls: ['https://www.prydwen.gg/wuthering-waves/weapons?search=Relativistic+Jet', 'https://game8.co/games/Wuthering-Waves/archives/474513', 'https://wutheringwaves.fandom.com/wiki/Relativistic_Jet'], checkedAt: '2026-08-25', provenanceNotes: ['R1-R5 ATK values, 16s duration and 20s trigger cooldown agree across the current cross-check sources.'] }),
  e({ effectId: 'WA-ATK', weaponId: 'woodland-aria', statOrEffect: 'ATK%', rankValues: R_12_24, effectType: 'PERMANENT', trigger: 'Passive', durationSeconds: null, maxStacks: 1, appliesTo: 'SELF', simulatorMode: 'ALWAYS', sourceEffectText: 'Permanent ATK increase; Aero-Erosion interactions separately grant Aero DMG and reduce the affected target’s Aero RES.', notes: 'Unconditional component of Lingering Summer Tune.', sourceLabels: ['Prydwen', 'Game8', 'Wutheringlab', 'Wuthering Waves Wiki'], sourceUrls: ['https://www.prydwen.gg/wuthering-waves/characters/ciaccona', 'https://game8.co/games/Wuthering-Waves/archives/514610', 'https://wutheringlab.com/weapon/woodland-aria/', 'https://wutheringwaves.fandom.com/wiki/Woodland_Aria'], checkedAt: '2026-08-25', provenanceNotes: ['R1-R5 ATK values agree across the current cross-check sources.'] }),
  e({ effectId: 'WA-AERO', weaponId: 'woodland-aria', statOrEffect: 'Aero DMG', rankValues: [.24, .30, .36, .42, .48], effectType: 'TRIGGERED', trigger: 'Inflict Aero Erosion on target', durationSeconds: 10, maxStacks: 1, appliesTo: 'SELF', simulatorMode: 'MANUAL', mechanicsStatus: 'VERIFIED_CONDITIONAL', sourceEffectText: 'Inflicting Aero Erosion grants the wielder a 10-second Aero DMG bonus.', notes: 'No uptime is assumed; the character/rotation must prove Aero Erosion application.', sourceLabels: ['Prydwen', 'Game8', 'Wutheringlab', 'Wuthering Waves Wiki'], sourceUrls: ['https://www.prydwen.gg/wuthering-waves/characters/ciaccona', 'https://game8.co/games/Wuthering-Waves/archives/514610', 'https://wutheringlab.com/weapon/woodland-aria/', 'https://wutheringwaves.fandom.com/wiki/Woodland_Aria'], checkedAt: '2026-08-25', provenanceNotes: ['R1-R5 Aero DMG values and 10s duration agree across the current cross-check sources.'] }),
  e({ effectId: 'WA-AERO-RES', weaponId: 'woodland-aria', statOrEffect: 'Aero RES Reduction', rankValues: [.10, .115, .13, .145, .16], effectType: 'TRIGGERED', trigger: 'Hit target affected by Aero Erosion', durationSeconds: 20, maxStacks: 1, appliesTo: 'TARGET', conditions: ['Target is affected by Aero Erosion'], simulatorMode: 'MANUAL', mechanicsStatus: 'VERIFIED_CONDITIONAL', sourceEffectText: 'Hitting an Aero-Eroded target reduces that target’s Aero RES for 20 seconds; same-name effects do not stack.', notes: 'Positive rank values store reduction magnitude. TARGET scope prevents this enemy debuff from being misread as a SELF/TEAM stat.', sourceLabels: ['Prydwen', 'Game8', 'Wutheringlab', 'Wuthering Waves Wiki'], sourceUrls: ['https://www.prydwen.gg/wuthering-waves/characters/ciaccona', 'https://game8.co/games/Wuthering-Waves/archives/514610', 'https://wutheringlab.com/weapon/woodland-aria/', 'https://wutheringwaves.fandom.com/wiki/Woodland_Aria'], checkedAt: '2026-08-25', provenanceNotes: ['R1-R5 Aero RES-reduction magnitudes, 20s duration and same-name non-stacking agree across the current cross-check sources.'] }),
